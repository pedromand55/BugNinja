...
╚═════╝  ╚═════╝  ╚═════╝     ╚═╝  ╚═══╝╚═╝╚═╝  ╚═══╝ ╚════╝ ╚═╝  ╚═╝
    ...
    """
        ...
        print(border_color + "└" + "─" * 61 + "┘")
        authors = "Created by: Lukas (pedromand55)"
...
╚═════╝  ╚═════╝  ╚═════╝     ╚═╝  ╚═══╝╚═╝╚═╝  ╚═══╝ ╚════╝ ╚═╝  ╚═╝
  ...
  Github - https://github.com/pedromand55/BugNinja
  Credit - Lukas (pedromand55)
            """,
            style="bold green",
            border_style="blue",
            expand=False
                    ...
                    try:
                        ...
                        if url_input:
                            ...
                            if single_url:
                                ...
                                clear_screen()
                                print(f"{Fore.GREEN}Welcome to the BugNinja SQL-Injector!\n")
                ...
                try:
                    ...
                    if url_input:
                        ...
                        if single_url:
                            ...
                            print(f"{Fore.GREEN}Welcome to the BugNinja XSS-Scanner!\n")
                except Exception as e:
                    print(f"{Fore.RED}[!] Error reading input file: {url_input}. Exception: {str(e)}")
                    input(f"{Fore.YELLOW}[i] Press Enter to try again...")
                    clear_screen()
